...
public class GetQueryResultsByName {

    ResultSet resultSet = null;

    /*Initialize class error logger*/
    Logger logger = LoggerFactory.getLogger(GetQueryResultsByName.class);


    public ResultSet getPersonAndCarDataFromQuery(Statement statement, String inputName) {
